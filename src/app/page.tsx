...
export default function HomePage() {
  ...
  return <div className="page-sheet home-page">
    ...
    <aside className="evidence-strip"><div><p className="overline">How to read this guide</p><h2>Evidence stays visible</h2></div><p>Authored records, generated constructions, limitations, and source links are labeled rather than blended together.</p><p><Link href="/common-medical-terms/" prefetch={false}>Browse common terms</Link><br /><Link href="/sources/" prefetch={false}>Review sources</Link><br /><Link href="/methodology/" prefetch={false}>Read the methodology</Link></p></aside>
  </div>;
}
